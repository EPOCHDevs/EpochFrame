...
TEST_CASE("FX Calendar Test")
{
    ...
    SECTION("test_regular_market_hours")
    {
        ...
        auto schedule =
            calendar->schedule("2024-01-08"__date.date(), "2024-01-12"__date.date(), {});
        ...
        auto monday_open = schedule.loc(Scalar{"2024-01-08"_date}, "MarketOpen")
                               ...
                               .to_datetime();
        REQUIRE(monday_open ==
                DateTime{{2024y, January, 7d},  {17h}}.tz_localize("America/New_York"));
        ...
        REQUIRE(monday_close ==
                DateTime{{2024y, January, 8d}, {17h}}.tz_localize("America/New_York"));
        ...
        REQUIRE(friday_close ==
                DateTime{{2024y, January, 12d},  {17h}}.tz_localize("America/New_York"));

        // Saturday and Sunday should not be valid trading days
        auto weekend_valid =
            calendar->valid_days("2024-01-13"__date.date(), "2024-01-14"__date.date());
    ...
    SECTION("test_dst_transition")
    {
        ...
        auto schedule =
            calendar->schedule("2024-03-11"__date.date(), "2024-03-11"__date.date(), {});
        ...
        auto monday_open = schedule.loc(Scalar{"2024-03-11"_date}, "MarketOpen")
                               ...
                               .to_datetime();
        REQUIRE(monday_open ==
                DateTime{{2024y, March, 10d}, {17h}}.tz_localize("America/New_York"));
    }
