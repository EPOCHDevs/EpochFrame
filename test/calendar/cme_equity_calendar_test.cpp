...
TEST_CASE("CME Equity Calendar", "[calendar]")
{
    ...
    SECTION("test_2016_early_closes")
    {
        ...
        std::vector<Date> early_close_dates = {
            "2016-01-18"__date.date(), "2016-02-15"__date.date(), "2016-05-30"__date.date(),
            "2016-07-04"__date.date(), "2016-09-05"__date.date(), "2016-11-24"__date.date()};
