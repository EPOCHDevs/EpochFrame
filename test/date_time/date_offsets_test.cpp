...
TEST_CASE("DateOffsets - Easter Handlers", "[date_offsets]") {
     ...
     std::vector<Param> params = {
            {efo::easter_offset(1), DateTime{.date={2010y, January, 1d}}, DateTime{.date={2010y, April, 4d}}},
            {efo::easter_offset(1), DateTime{.date={2010y, April, 5d}}, DateTime{.date={2011y, April, 24d}}},
        {efo::easter_offset(2), DateTime{.date={2010y, January, 1d}}, DateTime{.date={2011y, April, 24d}}},
        {efo::easter_offset(1), DateTime{.date={2010y, April, 4d}}, DateTime{.date={2011y, April, 24d}}},
        {efo::easter_offset(2), DateTime{.date={2010y, April, 4d}}, DateTime{.date={2012y, April, 8d}}},
        {efo::easter_offset(1)->negate(), DateTime{.date={2011y, January, 1d}}, DateTime{.date={2010y, April, 4d}}},
        {efo::easter_offset(1)->negate(), DateTime{.date={2010y, April, 5d}}, DateTime{.date={2010y, April, 4d}}},
        {efo::easter_offset(2)->negate(), DateTime{.date={2011y, January, 1d}}, DateTime{.date={2009y, April, 12d}}},
        {efo::easter_offset(1)->negate(), DateTime{.date={2010y, April, 4d}}, DateTime{.date={2009y, April, 12d}}},
        {efo::easter_offset(2)->negate(), DateTime{.date={2010y, April, 4d}}, DateTime{.date={2008y, March, 23d}}},
     };
