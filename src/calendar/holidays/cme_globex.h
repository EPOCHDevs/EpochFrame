...
namespace epoch_frame::calendar
{
    ...
    struct CMEGlobexHolidays
    {
        static CMEGlobexHolidays Instance()
        {
            static CMEGlobexHolidays instance;
            return instance;
        }
        ...
        /*
         * These holiday definitions are based on the pandas_market_calendars/holidays/cme_globex.py
         * implementation
         */
         ...
         * New Year's Day
         */
        const HolidayData USNewYearsDay = {.name  = "New Years Day",
                                           .month = std::chrono::January,
                                           .day   = 1d,
                                           .start_date =
                                               DateTime(Date{1952y, std::chrono::September, 29d}),
                                           .days_of_week = {
        ...
        const HolidayData FridayAfterThanksgiving = {
            ...
            .month  = std::chrono::November,
            .day    = 1d,
            .offset = {date_offset(TH(4)), days(1)},
        };
