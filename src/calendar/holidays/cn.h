...
namespace epoch_frame
{
    ...
    /*
     * These holiday definitions are based on the pandas_market_calendars/holidays/cn.py
     * implementation
     */
    ...
    const HolidayData ChineseSpringFestival2001 = {
        ...
        .month        = std::chrono::January,
        .day          = 24d,
        .start_date   = DateTime(Date{2001y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2001y, std::chrono::December, 31d}),
    ...
    const HolidayData ChineseSpringFestival2003 = {
        ...
        .month        = std::chrono::February,
        .day          = 1d,
        .start_date   = DateTime(Date{2003y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2003y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2004 = {
        ...
        .month        = std::chrono::January,
        .day          = 22d,
        .start_date   = DateTime(Date{2004y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2004y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2005 = {
        ...
        .month        = std::chrono::February,
        .day          = 9d,
        .start_date   = DateTime(Date{2005y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2005y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2006 = {
        ...
        .month        = std::chrono::January,
        .day          = 29d,
        .start_date   = DateTime(Date{2006y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2006y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2007 = {
        ...
        .month        = std::chrono::February,
        .day          = 18d,
        .start_date   = DateTime(Date{2007y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2007y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2008 = {
        ...
        .month        = std::chrono::February,
        .day          = 7d,
        .start_date   = DateTime(Date{2008y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2008y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2016 = {
        ...
        .month        = std::chrono::February,
        .day          = 8d,
        .start_date   = DateTime(Date{2016y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2016y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2017 = {
        ...
        .month        = std::chrono::January,
        .day          = 28d,
        .start_date   = DateTime(Date{2017y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2017y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2018 = {
        ...
        .month        = std::chrono::February,
        .day          = 16d,
        .start_date   = DateTime(Date{2018y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2018y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
    ...
    const HolidayData ChineseSpringFestival2019 = {
        ...
        .month        = std::chrono::February,
        .day          = 5d,
        .start_date   = DateTime(Date{2019y, std::chrono::January, 1d}),
        .end_date     = DateTime(Date{2019y, std::chrono::December, 31d}),
        .days_of_week = std::unordered_set<int>{0, 1, 2, 3, 4, 5, 6},
    };
