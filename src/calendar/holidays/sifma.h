...
namespace epoch_frame
{
    ...
    /*
     * These holiday definitions are based on the pandas_market_calendars/holidays/sifma.py
     * implementation
     */
    ...
    const HolidayData USMartinLutherKingJrAfter1998 = {
        ...
        .start_date = DateTime(Date{1983y, std::chrono::January, 1d}),
    };
    ...
    const HolidayData USHurricaneSandy2012 = {
        ...
        .month      = std::chrono::October,
        .day        = 29d,
        .start_date = DateTime(Date{2012y, std::chrono::October, 29d}),
        .end_date   = DateTime(Date{2012y, std::chrono::October, 30d})};
    ...
    const HolidayData BushSrFuneral2018 = {
        ...
        .month      = std::chrono::December,
        .day        = 5d,
        .start_date = DateTime(Date{2018y, std::chrono::December, 5d}),
        .end_date   = DateTime(Date{2018y, std::chrono::December, 5d})};
    ...
    const HolidayData NationalDayOfMourning2001 = {
        ...
        .month      = std::chrono::September,
        .day        = 14d,
        .start_date = DateTime(Date{2001y, std::chrono::September, 14d}),
        .end_date   = DateTime(Date{2001y, std::chrono::September, 14d})};
    ...
    const HolidayData ReaganFuneral2004 = {
        ...
        .month      = std::chrono::June,
        .day        = 11d,
        .start_date = DateTime(Date{2004y, std::chrono::June, 11d}),
        .end_date   = DateTime(Date{2004y, std::chrono::June, 11d})};
    ...
    const HolidayData FordFuneral2007 = {
        ...
        .month      = std::chrono::January,
        .day        = 2d,
        .start_date = DateTime(Date{2007y, std::chrono::January, 2d}),
        .end_date   = DateTime(Date{2007y, std::chrono::January, 2d})};
