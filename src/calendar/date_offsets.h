...
// #include "business_calendar/np_busdaycal.h"
...
namespace epochframe {
    ...
    struct TickHandler : FixedOffsetHandler {
        ...
        arrow::TimestampScalar add(const arrow::TimestampScalar &other) const override {
            return arrow::TimestampScalar(other.value + this->n() * this->nano_increments(), other.type);
        }
    ...
    chrono_year_month_day shift_month(chrono_year_month_day const &ymd, const chrono_months& months, std::optional<DayOption> const& day_opt);
...
// Week-Based Offset Classes
    class WeekHandler : public FixedOffsetHandler {
        public:
            ...
            std::string code() const override { return fmt::format("W{}", m_weekday ? fmt::format("-{}", EpochDayOfWeekWrapper::ToString(*m_weekday)) : ""); }
...
// -------------------------------------------------------------------------------
    class MonthOffsetHandler : public FixedOffsetHandler {
        public:
            MonthOffsetHandler(int64_t n, DayOption day_opt = DayOption::END) : FixedOffsetHandler(n), m_day_opt(day_opt) {}
            ...
            std::string code() const override { return "M"; }
    ...
    class MonthEndHandler : public MonthOffsetHandler {
        public:
            ...
            std::string code() const override { return "ME"; }
    ...
    class QuarterOffsetHandler : public FixedOffsetHandler {
        public:
            QuarterOffsetHandler(int64_t n, std::optional<std::chrono::month> starting_month = {}, DayOption day_opt = DayOption::END);
            ...
            std::string code() const override { return "Q"; }
    ...
    class QuarterStartHandler : public QuarterOffsetHandler {
        public:
            QuarterStartHandler(int64_t n, std::optional<std::chrono::month> starting_month = {}, DayOption day_opt = DayOption::START) : QuarterOffsetHandler(n, starting_month, day_opt) {}

            std::string code() const override { return "QS"; }
    ...
    class QuarterEndHandler : public QuarterOffsetHandler {
        public:
            QuarterEndHandler(int64_t n, std::optional<std::chrono::month> starting_month = {}, DayOption day_opt = DayOption::END) : QuarterOffsetHandler(n, starting_month, day_opt) {}

            std::string code() const override { return "QE"; }
    ...
    class YearOffsetHandler : public FixedOffsetHandler {
        public:
            YearOffsetHandler(int64_t n, std::optional<std::chrono::month> month = {}, DayOption day_opt = DayOption::END) : FixedOffsetHandler(n), m_month(month.value_or(std::chrono::December)), m_day_opt(day_opt) {}
            ...
            std::string code() const override { return "Y"; }
    ...
    class YearStartHandler : public YearOffsetHandler {
        public:
            YearStartHandler(int64_t n, std::optional<std::chrono::month> month = {}) : YearOffsetHandler(n, month, DayOption::START) {}

            std::string code() const override { return "YS"; }
    ...
    class YearEndHandler : public YearOffsetHandler {
        public:
            YearEndHandler(int64_t n, std::optional<std::chrono::month> month = {}) : YearOffsetHandler(n, month, DayOption::END) {}

            std::string code() const override { return "YE"; }
