...
namespace epoch_frame
{
    ...
    class Array
    {
      public:
         ...
         */
        template <typename T> static Array FromVector(const std::vector<T>& values);
        ...
        bool
        is_approx_equal(const Array&               other,
         ...
         * @return The result as an Array
         */
        Array call_function(const Array& other, const std::string& function_name,
                            const arrow::compute::FunctionOptions* options = nullptr) const;
         ...
         * @return The result as an Array
         */
        Array call_function(const Scalar& scalar, const std::string& function_name,
                            const arrow::compute::FunctionOptions* options = nullptr) const;
         ...
         */
        Scalar call_aggregate_function(const std::string& function_name, bool skip_nulls = true,
         ...
         * @return The casted Array
         */
        template <typename ArrowTypeClass> Array cast() const;
