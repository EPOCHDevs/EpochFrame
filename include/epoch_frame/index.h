...
namespace epoch_frame
{
    ...
    class IIndex
    {
      public:
        ...
        virtual IndexPtr drop(Array const& labels) const = 0;
        ...
        /// Return a new IIndex
        virtual IndexPtr insert(int64_t loc, Scalar const& value) const = 0;
        ...
        virtual std::vector<int64_t> get_loc(Scalar const& label) const   = 0;
        ...
        virtual ResolvedIntegerSliceBound slice_locs(Scalar const& start,
        ...
        virtual IndexType searchsorted(Scalar const&    label,
                                       SearchSortedSide side = SearchSortedSide::Left) const = 0;
        ...
        virtual IndexPtr filter(Array const& bool_filter, bool drop_null = true) const = 0;

        // 1) take(indices): Return a new IIndex with rows at positions in 'indices'
        virtual IndexPtr take(Array const& indices, bool bounds_check = true) const = 0;
