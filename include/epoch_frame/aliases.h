...
namespace epoch_frame
{
    ...
    template <bool is_array> class StringOperation;
    ...
    using LocRowArgumentVariant =
        std::variant<SliceType, Series, IndexPtr, Array, DataFrameToSeriesCallable>;
    using LocColArgumentVariant = std::variant<StringVector, Array, StringVectorCallable>;
    using WhereConditionVariant = std::variant<Series, DataFrame, Array, DataFrameToSeriesCallable,
                                               DataFrameToDataFrameCallable>;
    using WhereOtherVariant = std::variant<Scalar, Series, DataFrame, DataFrameToDataFrameCallable>;
